...
You may want to write your own script with your dataset and other customizations.
"""
import sys
...
TRAIN_JSON = os.path.join(ANN_ROOT, 'instances_train2017.json') # 训练集标注文件路径
VAL_JSON = os.path.join(ANN_ROOT, 'instances_val2017.json')     # 验证集标注文件路径
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        It calls :func:`detectron2.dataset.build_detection_train_loader` with a customized
